    ...
    <div style="background-image: url(img/parchment2.jpg);
        ...
        <div class="row row-content">
            <div class="col-md-8 col-10 mx-auto">
                <div id="racesCarousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img class="d-none d-md-block w-100" src="img/Races.jpg"
                                style="height: 500px; object-fit: cover;" alt="RacesArt">
                            <img class="d-md-none d-block w-100" src="img/Races.jpg"
                                style="height: 250px; object-fit: cover;" alt="RacesArt">
                            <div class="carousel-caption">
                                <h3>Discover Races</h3>
                                <p class="d-none d-sm-block">Let Dungeons and Dragons 101 be your guide to choosing your
                                    first race</p>
                            </div>
                        </div>
                    </div>
        ...
        <div
            ...
            <div class="row row-content">
                <div class="col align-self-center">
                    <h1 class="text-center">What Race Will You Be?</h1>
                </div>
            </div>
        </div>
        <div class="container-fluid ml-3" id="races">
            <div class="row">
                <div class="col mb-4 mt-4">
                    <div class="card" style="width: 440px; height: 38rem;">
                        <h5 class="card-header text-center">Dragonborn</h5>
                        <nav>
                            <ul class="nav nav-tabs" id="dragonborn-list" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" data-toggle="tab" href="#dragonbornMain" role="tab"
                                        aria-controls="dragonbornMain" aria-selected="true">Main</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#dragonbornStuff" role="tab"
                                        aria-controls="dragonbornStuff" aria-selected="false">Proud Dragon Kin</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#dragonbornMoreStuff" role="tab"
                                        aria-controls="dragonbornMoreStuff" aria-selected="false">Self-Sufficient
                                        Clans</a>
                                </li>
                            </ul>
                        </nav>
                        <div class="card-body">
                            <div class="tab-content">
                                <div class="tab-pane active" id="dragonbornMain" role="tabpanel">
                                    <div class="row">
                                        <div class="col">
                                            <div class="card-inner">
                                                <img src="img/DND-Dragonborn-Race.jpg_large"
                                                    class="card-img"
                                                    style="width: 380px; height: 30rem;" alt="Dragonborn Class">
                                ...
                                <div class="tab-pane" id="dragonbornStuff" role="tabpanel"
                                    aria-labelledby="dragonbornStuff-tab">
                                    <p class="card-text scroll p-2" style="max-height: 30rem;">
                                ...
                                <div class="tab-pane" id="dragonbornMoreStuff" role="tabpanel"
                                    aria-labelledby="dragonbornMoreStuff-tab">
                                    <p class="card-text scroll p-2" style="max-height: 30rem;">
                ...
                <div class="col mb-4 mt-4">
                    <div class="card" style="width: 460px;  height: 38rem;">
                        <h5 class="card-header text-center">Dwarf</h5>
                        <nav>
                            <ul class="nav nav-tabs" id="dwarf-list" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" data-toggle="tab" href="#dwarfMain" role="tab"
                                        aria-controls="dwarfMain" aria-selected="true">Main</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#dwarfStuff" role="tab"
                                        aria-controls="dwarfStuff" aria-selected="false">Short & Stout</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#dwarfMoreStuff" role="tab"
                                        aria-controls="dwarfMoreStuff" aria-selected="false">Long Memory, Long
                                        Grudges</a>
                                </li>
                            </ul>
                        </nav>
                        <div class="card-body">
                            <div class="tab-content">
                                <div class="tab-pane active" id="dwarfMain" role="tabpanel">
                                    <div class="row">
                                        <div class="col">
                                            <div class="card-inner">
                                                <img src="img/DND-Dwarf-Race.png" 
                                                class="card-img mx-auto d-block"
                                                style="width: 380px; height: 30rem;" alt="Dwarf Class">
                                                <div class="card-img-overlay">
                                                    <p>
                                ...
                                <div class="tab-pane" id="dwarfStuff" role="tabpanel" aria-labelledby="dwarfStuff-tab">
                                    <p class="card-text scroll p-2" style="max-height: 30rem;">
                                ...
                                <div class="tab-pane" id="dwarfMoreStuff" role="tabpanel"
                                    aria-labelledby="dwarfMoreStuff-tab">
                                    <p class="card-text scroll p-2" style="max-height: 30rem;">
                ...
                <div class="col mb-4 mt-4">
                    <div class="card" style="width: 460px; height: 38rem;">
                        <h5 class="card-header text-center">Elf</h5>
                        <nav>
                            <ul class="nav nav-tabs" id="elf-list" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" data-toggle="tab" href="#elfMain" role="tab"
                                        aria-controls="elfMain" aria-selected="true">Main</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#elfStuff" role="tab"
                                        aria-controls="elfStuff" aria-selected="false">Slender & Graceful</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#elfMoreStuff" role="tab"
                                        aria-controls="elfMoreStuff" aria-selected="false">A Timeless Perspective</a>
                                </li>
                            </ul>
                        </nav>
                        <div class="card-body">
                            <div class="tab-content">
                                <div class="tab-pane active" id="elfMain" role="tabpanel">
                                    <div class="row">
                                        <div class="col">
                                            <div class="card-inner">
                                                <img src="img/DND-Elf-Race.png" class="card-img mx-auto d-block"
                                                style="width: 380px; height: 30rem;" alt="Elf Class">
                                                <div class="card-img-overlay">
                                                    <p>
                                ...
                                <div class="tab-pane" id="elfStuff" role="tabpanel" aria-labelledby="elfStuff-tab">
                                    <p class="card-text scroll p-2" style="max-height: 30rem;">
                                ...
                                <div class="tab-pane" id="elfMoreStuff" role="tabpanel"
                                    aria-labelledby="elfMoreStuff-tab">
                                    <p class="card-text scroll p-2" style="max-height: 30rem;">
                ...
                <div class="col mb-4 mt-4">
                    <div class="card" style="width: 450px; height: 38rem;">
                        <h5 class="card-header text-center">Gnome</h5>
                        <nav>
                            <ul class="nav nav-tabs" id="gnome-list" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" data-toggle="tab" href="#gnomeMain" role="tab"
                                        aria-controls="gnomeMain" aria-selected="true">Main</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#gnomeStuff" role="tab"
                                        aria-controls="gnomeStuff" aria-selected="false">Vibrant Expression</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#gnomeMoreStuff" role="tab"
                                        aria-controls="gnomeMoreStuff" aria-selected="false">Delighted Dedication</a>
                                </li>
                            </ul>
                        </nav>
                        <div class="card-body">
                            <div class="tab-content">
                                <div class="tab-pane active" id="gnomeMain" role="tabpanel">
                                    <div class="row">
                                        <div class="col">
                                            <div class="card-inner">
                                                <img src="img/DND-Gnome-Race.jpg" class="card-img mx-auto d-block"
                                                style="width: 380px; height: 30rem;" alt="Gnome Class">
                                                <div class="card-img-overlay">
                                                    <p>
                                ...
                                <div class="tab-pane" id="gnomeStuff" role="tabpanel" aria-labelledby="gnomeStuff-tab">
                                    <p class="card-text scroll p-2" style="max-height: 30rem;">
                                ...
                                <div class="tab-pane" id="gnomeMoreStuff" role="tabpanel"
                                    aria-labelledby="gnomeMoreStuff-tab">
                                    <p class="card-text scroll p-2" style="max-height: 30rem;">
                ...
                <div class="col mb-4 mt-4">
                    <div class="card" style="width: 450px; height: 38rem;">
                        <h5 class="card-header text-center">Half-Elf</h5>
                        <nav>
                            <ul class="nav nav-tabs" id="halfelf-list" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" data-toggle="tab" href="#halfelfMain" role="tab"
                                        aria-controls="halfelfMain" aria-selected="true">Main</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#halfelfStuff" role="tab"
                                        aria-controls="halfelfStuff" aria-selected="false">Of Two Worlds</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#halfelfMoreStuff" role="tab"
                                        aria-controls="halfelfMoreStuff" aria-selected="false">Diplomats or
                                        Wanderers</a>
                                </li>
                            </ul>
                        </nav>
                        <div class="card-body">
                            <div class="tab-content">
                                <div class="tab-pane active" id="halfelfMain" role="tabpanel">
                                    <div class="row">
                                        <div class="col">
                                            <div class="card-inner">
                                                <img src="img/DND-Half-Elf-Race.png" class="card-img mx-auto d-block"
                                                style="width: 380px; height: 30rem;" alt="Half-Elf Class">
                                                <div class="card-img-overlay">
                                ...
                                <div class="tab-pane" id="halfelfStuff" role="tabpanel"
                                    aria-labelledby="halfelfStuff-tab">
                                    <p class="card-text scroll p-2" style="max-height: 30rem;">
                                ...
                                <div class="tab-pane" id="halfelfMoreStuff" role="tabpanel"
                                    aria-labelledby="halfelfMoreStuff-tab">
                                    <p class="card-text scroll p-2" style="max-height: 30rem;">
                ...
                <div class="col mb-4 mt-4">
                    <div class="card" style="width: 450px; height: 38rem;">
                        <h5 class="card-header text-center">Halfling</h5>
                        <nav>
                            <ul class="nav nav-tabs" id="halfling-list" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" data-toggle="tab" href="#halflingMain" role="tab"
                                        aria-controls="halflingMain" aria-selected="true">Main</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#halflingStuff" role="tab"
                                        aria-controls="halflingStuff" aria-selected="false">Small & Practical</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#halflingMoreStuff" role="tab"
                                        aria-controls="halflingMoreStuff" aria-selected="false">Kind & Curious</a>
                                </li>
                            </ul>
                        </nav>
                        <div class="card-body">
                            <div class="tab-content">
                                <div class="tab-pane active" id="haflingMain" role="tabpanel">
                                    <div class="row">
                                        <div class="col">
                                            <div class="card-inner">
                                                <img src="img/DND-Halfling-Race.jpg" class="card-img mx-auto d-block"
                                                style="width: 380px; height: 30rem;" alt="Halfling Class">
                                                <div class="card-img-overlay">
                                                    <p>
                                ...
                                <div class="tab-pane" id="halflingStuff" role="tabpanel"
                                    aria-labelledby="halflingStuff-tab">
                                    <p class="card-text scroll p-2" style="max-height: 30rem;">
                                ...
                                <div class="tab-pane" id="halflingMoreStuff" role="tabpanel"
                                    aria-labelledby="halflingMoreStuff-tab">
                                    <p class="card-text scroll p-2" style="max-height: 30rem;">
                ...
                <div class="col mb-4 mt-4">
                    <div class="card" style="width: 450px; height: 38rem;">
                        <h5 class="card-header text-center">Half-Orc</h5>
                        <nav>
                            <ul class="nav nav-tabs" id="halforc-list" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" data-toggle="tab" href="#halforcMain" role="tab"
                                        aria-controls="halforcMain" aria-selected="true">Main</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#halforcStuff" role="tab"
                                        aria-controls="halforcStuff" aria-selected="false">Scarred & Strong</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#halforcMoreStuff" role="tab"
                                        aria-controls="halforcMoreStuff" aria-selected="false">The Mark of Gruumsh</a>
                                </li>
                            </ul>
                        </nav>
                        <div class="card-body">
                            <div class="tab-content">
                                <div class="tab-pane active" id="halforcMain" role="tabpanel">
                                    <div class="row">
                                        <div class="col">
                                            <div class="card-inner">
                                                <img src="img/DND-Half-Orc-Race.jpg" class="card-img mx-auto d-block"
                                                style="width: 380px; height: 30rem;" alt="Half-Orc Class">
                                                <div class="card-img-overlay">
                                                    <p>
                                ...
                                <div class="tab-pane" id="halforcStuff" role="tabpanel"
                                    aria-labelledby="halforcStuff-tab">
                                    <p class="card-text scroll p-2" style="max-height: 30rem;">
                                ...
                                <div class="tab-pane" id="halforcMoreStuff" role="tabpanel"
                                    aria-labelledby="halforcMoreStuff-tab">
                                    <p class="card-text scroll p-2" style="max-height: 30rem;">
                ...
                <div class="col mb-4 mt-4">
                    <div class="card" style="width: 450px; height: 38rem;">
                        <h5 class="card-header text-center">Human</h5>
                        <nav>
                            <ul class="nav nav-tabs" id="human-list" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" data-toggle="tab" href="#humanMain" role="tab"
                                        aria-controls="humanMain" aria-selected="true">Main</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#humanStuff" role="tab"
                                        aria-controls="humanStuff" aria-selected="false">A Broad Spectrum</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#humanMoreStuff" role="tab"
                                        aria-controls="humanMoreStuff" aria-selected="false">Variety in All Things</a>
                                </li>
                            </ul>
                        </nav>
                        <div class="card-body">
                            <div class="tab-content">
                                <div class="tab-pane active" id="humanMain" role="tabpanel">
                                    <div class="row">
                                        <div class="col">
                                            <div class="card-inner">
                                                <img src="img/DND-Human-Race.jpg" class="card-img mx-auto d-block"
                                                style="width: 380px; height: 30rem;" alt="Human Class">
                                                <div class="card-img-overlay">
                                                    <p>
                                ...
                                <div class="tab-pane" id="humanStuff" role="tabpanel" aria-labelledby="humanStuff-tab">
                                    <p class="card-text scroll p-2" style="max-height: 30rem;">
                                ...
                                <div class="tab-pane" id="humanMoreStuff" role="tabpanel"
                                    aria-labelledby="humanMoreStuff-tab">
                                    <p class="card-text scroll p-2" style="max-height: 30rem;">
                ...
                <div class="col mb-4 mt-4">
                    <div class="card" style="width: 460px; height: 38rem;">
                        <h5 class="card-header text-center">Tiefling</h5>
                        <nav>
                            <ul class="nav nav-tabs" id="tiefling-list" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" data-toggle="tab" href="#tieflingMain" role="tab"
                                        aria-controls="tieflingMain" aria-selected="true">Main</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#tieflingStuff" role="tab"
                                        aria-controls="tieflingStuff" aria-selected="false">Infernal Bloodline</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#tieflingMoreStuff" role="tab"
                                        aria-controls="tieflingMoreStuff" aria-selected="false">Self-Reliant &
                                        Suspicious</a>
                                </li>
                            </ul>
                        </nav>
                        <div class="card-body">
                            <div class="tab-content">
                                <div class="tab-pane active" id="tieflingMain" role="tabpanel">
                                    <div class="row">
                                        <div class="col">
                                            <div class="card-inner">
                                                <img src="img/Mollymauk_Official_byArianaOrner.png"
                                                    class="card-img mx-auto d-block" 
                                                    style="width: 380px; height: 30rem;" alt="Tiefling Class">
                                                <div class="card-img-overlay">
                                                    <p>
                                ...
                                <div class="tab-pane" id="tieflingStuff" role="tabpanel"
                                    aria-labelledby="tieflingStuff-tab">
                                    <p class="card-text scroll p-2" style="max-height: 30rem;">
                                ...
                                <div class="tab-pane" id="tieflingMoreStuff" role="tabpanel"
                                    aria-labelledby="tieflingMoreStuff-tab">
                                    <p class="card-text scroll p-2" style="max-height: 30rem;">
